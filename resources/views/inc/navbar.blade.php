<header >
    <h1 style="background-color: lightgray; margin:0px">MOBI WORLD</h1>
</header>
...
<nav class="navbar navbar-expand-md bg-dark navbar-dark shadow-sm">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item">
                <a class = "nav-link" href="/mobiworld/public/inc/aboutus">About Us</a>
                
            </li>
            <li class="nav-item">
            <a class="nav-link" href="/mobiworld/public/inc/contact-form">Contact US</a>
