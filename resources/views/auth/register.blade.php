...
@section('content')
<form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" class="container mt-3">
    @csrf
    ...
    <div class="form-group">
        <label for="address">Residential Address:</label> <span style="color:red">*</span>
